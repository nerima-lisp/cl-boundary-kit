...
stable contract under the [stability policy](docs/src/stability-policy.md), so
the goal of subsequent `1.x` work is usability and adoption quality rather than
surface growth.
