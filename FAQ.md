...
For `0.5.x`, any intentionally breaking compatibility change should also update
...
For `0.5.x`, stability claims are intentionally narrow. The effective public
