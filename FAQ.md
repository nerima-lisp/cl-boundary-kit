...
For `0.2.x`, any intentionally breaking compatibility change should also update
...
For `0.2.x`, stability claims are intentionally narrow. The effective public
