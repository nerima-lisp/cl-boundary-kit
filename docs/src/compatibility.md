...
that as a broken compatibility promise by itself. Use [Support](support.md)
for ordinary compatibility questions, reproducible contract failures, or
documentation drift, and use [Security](security.md) when the behavior
...
with `README.md`, this document, and [Changelog](changelog.md).
